      ...
      {isLoggedIn && user ? ( // Kiểm tra trạng thái đăng nhập
        <div className="relative inline-block text-left">
          <button
            ...
            className={
              isMobile
                ? "flex items-center gap-2 text-white bg-[#bb8d38] hover:bg-[#e09e09] px-6 py-2 text-sm font-medium rounded-full"
                : "hidden md:inline-flex items-center gap-2 text-white bg-[#bb8d38] hover:bg-[#e09e09] focus:ring-4 focus:outline-none focus:ring-yellow-300 font-medium rounded-[45px] text-sm px-6 py-3 text-center"
            }
          >
            <IconUser />
